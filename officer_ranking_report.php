...
$can_view = $budget_manager->checkAccess($staff['user_id'], 'can_view_budget');
...
// Get officers and departments for filtering
$target_manager->db->query("
    SELECT DISTINCT user_id, full_name, department 
    FROM staffs 
    WHERE department IN ('Wealth Creation', 'Accounts', 'Leasing')
    ORDER BY full_name ASC
");
$officers = $target_manager->db->resultSet();

$departments = ['Wealth Creation', 'Accounts', 'Leasing'];

// Apply filters
if ($selected_officer) {
    $officer_ranking = array_filter($officer_ranking, function($officer) use ($selected_officer) {
        return $officer['officer_id'] == $selected_officer;
    });
}

if ($selected_department) {
    $officer_ranking = array_filter($officer_ranking, function($officer) use ($selected_department) {
        return $officer['department'] == $selected_department;
    });
}
...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <?php if ($selected_officer || $selected_department): ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Ranking Filters</h3>
            <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="department" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
